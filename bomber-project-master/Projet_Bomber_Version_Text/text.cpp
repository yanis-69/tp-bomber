...
{
    const terrain& t = jeu.GetConstTerrain(); // création du terrain
    const joueur& j = jeu.GetConstJoueur(); // céation du joueu principale
    ...
    if(bp.estpose==true)
    {
        win.print(bp.getBombe_x(),bp.getBombe_y(),'b');
        //cout<<b.getBombe_x()<<b.getBombe_y();
    }
    if(b2.estpose==true)
    {
        win.print(b2.getBombe_x(),b2.getBombe_y(),'B2');
        //cout<<b.getBombe_x()<<b.getBombe_y();
    }
    if(b3.estpose==true)
    {
        win.print(b3.getBombe_x(),b3.getBombe_y(),'B3');
        //cout<<b.getBombe_x()<<b.getBombe_y();
    }
...
// *******************************************************************************
    ...
    /// gère l'ordi placé coté haut droit
...
// *******************************************************************************
// *******************************************************************************
    /// gère l'ordi placé coté Bas Gauche
        // jeu.actionsAutomatiques();
...
// *******************************************************************************
    ...
    /// gère l'ordi placé coté Bas Droit
        // jeu.actionsAutomatiques();
...
// *******************************************************************************
     ...
     /// gère les déplacements du joueur principale
        c = win.getCh();
